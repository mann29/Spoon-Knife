				...
				<td class="section-padding">
					<table border="0" cellpadding="0" cellspacing="0" width="50%" ID="Table5">
						<tr>
							...
							<tr>
								<td class="data-table-head-first" colspan="2" style="border-style: none">Lohnsatz ($/Std.)</td>
							</tr>
							<tr>
				...
				<td class="subsection-content">
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" class="data-table" ID="Table3">
						<tr>
							...
							<td class="data-table-head" colspan="3" style="border-bottom: 0px;">Teile</td>
							<td class="data-table-head" colspan="2" style="border-bottom: 0px;">Preis</td>
							<td class="data-table-head" colspan="3" style="border-bottom: 0px;">Arbeitskosten</td>
							<td class="data-table-head-end" rowspan="2">Betrag</td>
						</tr>
						<tr>
							<td class="data-table-head" style="border-top: 1px solid #bebebe;">Typ</td>
							<td class="data-table-head" style="border-top: 1px solid #bebebe;">Anzahl</td>
							<td class="data-table-head" style="border-top: 1px solid #bebebe;">Menge</td>
							<td class="data-table-head" style="border-top: 1px solid #bebebe;">Einheit</td>
							<td class="data-table-head" style="border-top: 1px solid #bebebe;">Erweitert</td>
							<td class="data-table-head" style="border-top: 1px solid #bebebe;">Typ</td>
		...
		<tr>
			<td class="subsection-content">
				...
				<table>
					...
					<tr>
						<td class="data-right">   </td>
						<td class="data">3b. Aktualisieren und kalkulieren Sie die Schätzung und klicken Sie dann auf die Schaltfläche eCM, um die Schätzung auszuführen und um zu eClaim zurückzukehren.</td>
					</tr>
					<tr>
						<td class="data-right"> </td>
					...
					<tr>
						<td class="data-right">   </td>
						<td class="data">3a. Öffnen Sie Ihre Schätzungs-Software.</td>
					</tr>
					<tr>
						<td class="data-right">   </td>
						<td class="data">3b. Die Schätzung aktualisieren und dann Sperren/Ausführen.</td>
					</tr>
					<tr>
						<td class="data-right">   </td>
						<td class="data">3c. Exportieren Sie den EMS für die Schätzung aus Ihrer Schätzungs-Software.</td>
					</tr>
					<tr>
						<td class="data-right">   </td>
						<td class="data">3d. Erstellen Sie einen Druck der Schätzung im PDF-Format.</td>
					</tr>
					<tr>
						<td class="data-right">   </td>
