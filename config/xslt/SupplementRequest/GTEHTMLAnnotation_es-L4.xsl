...
<xsl:template name="body">
	 <xsl:variable name="staticImageUrl"  select="/sup:SupplementRequest/sup:StaticImageBaseUrl" />
	 <xsl:variable name="signatureImage" select="/sup:SupplementRequest/sup:SignatureImage"/>
   <xsl:variable name="currYear" select="/sup:SupplementRequest/sup:CurrentYear"/>
   <xsl:variable name="isDaytonaShop" select="/sup:SupplementRequest/sup:IsDaytonaShop"/>
	<body style="background-color:#DFDEDE">
	        <xsl:choose>
			 <xsl:when test="count(/sup:SupplementRequest/sup:LineItemsInfo/sup:LineItemInfo) > 0 or string-length(/sup:SupplementRequest/sup:DeskReviewInfo/sup:Comments) > 0 or count(/sup:SupplementRequest/sup:EstimateProfile/sup:RateInfo) > 0 or ($isDaytonaShop) = 'true'">
			 ...
			 <xsl:otherwise>
                ...
                <tr><td colspan="3" class="LDAMasterBackGroundColor" style="height: 7px; text-align: left;"></td></tr>
                <tr>
                  ...
                  <td align="center" width="600">
                   ...
                   <tr>
			           <td style="padding-left:15px; text-align: left;font-size: 35px;" colspan="2">
		             	 <span class="LDAMasterForeColor">Solicitud de modificación para Nº de siniestro <xsl:value-of select="/sup:SupplementRequest/sup:AdminInfo/sup:ClaimNumber" /></span>
		            	</td>
		            </tr>
					<tr><td colspan="2"> </td> </tr>
					<xsl:if test="string-length(/sup:SupplementRequest/sup:AdminInfo/sup:URLLink) > 0">
					<tr> 
					  <td style="padding-left:15px; font-size: 16px; text-align: left;" colspan="2">
					     <span class="LDAMasterForeColor"> Para ver el encargo completo, haga clic en el siguiente enlace y especifique el Número de identificación del vehículo (VIN) asociado con este siniestro.</span><br/>
   					     <xsl:call-template name="urlSupp"/>
					 </td>
					</tr>
					</xsl:if>
                    <tr><td colspan="2"><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text></td></tr>
					 <tr>
                        ...
                        <td class="LabelValue" style="font-weight: bold;">
                            <xsl:value-of select="/sup:SupplementRequest/sup:AdminInfo/sup:ClaimId" />
                        </td>
                    </tr>
                    <tr>
                        <td class="LabelText" style="padding-left:15px;">
                            <xsl:value-of select="/sup:SupplementRequest/sup:AdminInfo/sup:SuffixLabel" />:
                        </td>
                        <td class="LabelValue" style="font-weight: bold;">
                           <xsl:value-of select="/sup:SupplementRequest/sup:AdminInfo/sup:Suffix" />
                        </td>
                    </tr>
                    <tr>
                        <td class="LabelText" style="padding-left:15px;">
                        ...
                        <td class="LabelValue" style="font-weight: bold;">
                            <xsl:value-of select="/sup:SupplementRequest/sup:VehicleInfo/sup:LicensePlate" />
                        </td>
                    </tr>
                    <tr>
                        <td class="LabelText" style="padding-left:15px;">
					...
					<xsl:call-template name="GTinstructionSupp"/>
            ...
            <tr>
              <td style="padding-left:15px; text-align: left;font-weight: bold;" colspan="2">
                <p class="LabelValue">
                  Para cualquier aclaración o incidencia sobre este proceso, puede enviarnos un correo electrónico a través de
            ...
            <td colspan="2">
                <table style="text-align:Center">
                    <tr class="Footer">
                        ...
                        <td>
                            © <xsl:value-of select="$currYear" /> Mitchell International, Inc. All Rights Reserved. This message is intended only for recipient <xsl:value-of select="/sup:SupplementRequest/sup:AdminInfo/sup:ReceipientInfo/sup:Name" />. If you are not the intended recipient you are notified that disclosing, copying, distributing or taking any action in reliance on the contents of this information is strictly prohibited.
                        </td>
                    </tr>
                </table>
            </td>
				...
				<td class="section-padding">
					<table border="0" cellpadding="0" cellspacing="0" width="50%" ID="Table5">
						<tr>
							...
							<tr>
								<td class="data-table-head-first" style="border-style: none">Tarifa MO (<xsl:value-of select="/sup:SupplementRequest/sup:AdminInfo/sup:Currency" />/h)</td>
				...
				<td class="subsection-content">
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" class="data-table" ID="Table3">
						<tr>
							...
							<td class="data-table-head" rowspan="2">Tipo</td>
							<td class="data-table-head" rowspan="2">Número</td>
							<td class="data-table-head" rowspan="2">Cantidad</td>
							<td class="data-table-head" rowspan="2">Unidad</td>
							<td class="data-table-head" rowspan="2">Ampliado</td>
							<td class="data-table-head" rowspan="2">Tipo</td>
...
<a href="{$vlink}" class="LDAMasterForeColor" style="font-size: 24px; font-weight: bold;">Enlace</a>
</xsl:template>
...
<xsl:template name="GTinstructionSupp">
  <xsl:if test="string-length(/sup:SupplementRequest/sup:AdminInfo/sup:URLLink) &lt;= 0">
		<!--Section Instructions -->
		<tr>
			<td class="LDAMasterForeColor" style="padding-left:15px; text-align: left; font-size:40x; font-weight:bold;" colspan="2">
				Instrucciones de modificación para valoraciones
            </td>
		</tr>
		<tr>
			<td class="LabelValue" style="padding-left:15px; text-align: left; font-size: 14px; font-weight:bold;" colspan="2">
				<table style="text-align: left; font-size: 14px; font-weight:bold;">
					<tr>
					<td class="LabelValue" style="text-align: left; font-size: 14px; font-weight:bold;">1. </td>
					<td class="LabelValue" style="text-align: left; font-size: 14px; font-weight:bold;">Iniciar sesión en RepairCenter Connect.</td>
					</tr>
					<tr>
					<td class="LabelValue" style="text-align: left; font-size: 14px; font-weight:bold;">2. </td>
					<td class="LabelValue" style="text-align: left; font-size: 14px; font-weight:bold;">Ir a la página Detalles del encargo para ver su encargo.</td>
					</tr>
					<tr>
					<td class="LabelValue" style="text-align: left; font-size: 14px; font-weight:bold;">3. </td>
					<td class="LabelValue" style="text-align: left; font-size: 14px; font-weight:bold;">Complete las instrucciones mostradas en la página.
					</td>
					</tr>
				</table>
			</td>
			...
			<td class="subsection-content">
				...
				<table>
					<tr>
						...
						<td class="data">Iniciar sesión en RepairCenter Connect.</td>
					</tr>
					<tr>
						<td class="data-right">2. </td>
						<td class="data">Ir a la página Detalles del encargo para ver su encargo.</td>
					</tr>
					<tr>
						<td class="data-right">3. </td>
						<td class="data">Complete las instrucciones mostradas en la página.
						</td>
					</tr>
				</table>
			</td>
