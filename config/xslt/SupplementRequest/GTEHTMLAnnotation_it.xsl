...
<!--     <tr>
           <xsl:for-each select="//sup:RateInfo">    
          	...
          	<td class="data-field">                
													...
													<xsl:value-of select="string($supt)"/>:</td>
				...
				<td class="section-padding">
					<table border="0" cellpadding="0" cellspacing="0" width="50%" ID="Table5">
						<tr>
							...
							<tr>
								<td class="data-table-head-first" style="border-style: none">Tariffa manodopera <xsl:value-of select="/sup:SupplementRequest/sup:AdminInfo/sup:Currency" />/ora</td>
			...
			<tr>
				<td class="subsection-content">
					...
					<div class="col-bg-large">
						<span class="subsection">Annotazioni voce di linea</span>
					</div>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" class="data-table" ID="Table3">
						<tr>
							...
							<td class="data-table-head" rowspan="2">Numero</td>
							<td class="data-table-head" rowspan="2">Quantità</td>
							<td class="data-table-head" rowspan="2">Unità</td>
							<td class="data-table-head" rowspan="2">Esteso</td>
							<td class="data-table-head" rowspan="2">Tipo</td>
		...
		<tr>
			<td class="subsection-content">
				...
				<table>
					<tr>
						<td class="data-right">1. </td>
						<td class="data">Accedere a RepairCenter Connect.</td>
					</tr>
					<tr>
						<td class="data-right">2. </td>
						<td class="data">Aprirela pagina Dettagli incarico per visualizzare l'incarico.</td>
					</tr>
					<tr>
						<td class="data-right">3. </td>
						<td class="data">Completare le istruzioni visualizzate nella pagina.
						</td>
					</tr>
				</table>
			</td>
