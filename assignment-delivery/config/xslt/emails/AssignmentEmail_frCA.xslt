...
<xsl:otherwise>
Nouvelle assignation-</xsl:otherwise></xsl:choose><xsl:value-of select="/CreationSubject/CoName" /><xsl:if test="string-length(/CreationSubject/ClaimNumber) > 0"> pour le numéro de réclamation : <xsl:value-of select="/CreationSubject/ClaimNumber" />.</xsl:if>
</xsl:template>
						...
						<table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									...
									<p class="text" style="line-height:22px; color:#333333">L'assignation d'évaluation suivante vous a été attribuée <xsl:choose><xsl:when test="$assignmentSubTypeDescBdy!=''"><b><xsl:value-of select="$assignmentSubTypeDescBdy" /></b> Assignation de l'évaluation</xsl:when>
									<xsl:otherwise>Assignation de l'évaluation</xsl:otherwise></xsl:choose></p>
									<!--By vb101824 for PBI 292181 -->
									<p class="text" style="line-height:22px; color:#333333">Si vous n'utilisez pas RC Connect pour communiquer avec cet assureur, veuillez ignorer ce courriel. <ul>
									...
									<br/>
									<p>
									<xsl:call-template name="url"/><br/> Veuillez cliquer sur le lien suivant et entrer le numéro d'identification du véhicule associé à cette réclamation.
									</p>
					...
					<td width="600" align="center">
						...
						<table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									<p class="text" style="line-height:22px; font-size:16px; color:#72a493; font-weight:bold">Nouvelle assignation</p>
									<p class="text" style="line-height:22px; color:#333333">L'assignation d'évaluation suivante vous a été attribuée <xsl:choose><xsl:when test="$assignmentSubTypeDescBdyDRP!=''"><b><xsl:value-of select="$assignmentSubTypeDescBdyDRP" /></b> Assignation de l'évaluation</xsl:when>
									<xsl:otherwise>Assignation de l'évaluation</xsl:otherwise></xsl:choose></p>
									<!--By vb101824 for PBI 292181 -->
									<p class="text" style="line-height:22px; color:#333333">Si vous n'utilisez pas RC Connect pour communiquer avec cet assureur, veuillez ignorer ce courriel. <ul>
										<li>EXCEPTION : Si vous êtes un réparateur hors réseau recevant une assignation pour cette compagnie d'assurance, veuillez conserver ce courriel. Il contient le seul lien que vous recevrez pour accéder aux renseignements.</li>
									...
									<br/>
									<p>
									<xsl:call-template name="urlDRP"/><br/> Veuillez cliquer sur le lien suivant et entrer le numéro d'identification du véhicule associé à cette réclamation.
									</p>
						...
						<table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									...
									<p class="text" style="line-height:22px; font-size:16px; color:#72a493; font-weight:bold">Échec du chargement de l'estimation</p>
									...
									<p>Veuillez charger votre estimation à nouveau en utilisant le lien fourni dans le courriel d'assignation initial.</p>
...
Estimation téléversée avec succès pour <xsl:value-of select="/UploadSuccessSubject/CoName" /> Réclamation : <xsl:value-of select="/UploadSuccessSubject/ClaimNumber" />
</xsl:template>

<xsl:template match="/UploadFailSubject">
Échec du chargement de l'estimation pour <xsl:value-of select="/UploadFailSubject/CoName" /> Réclamation : <xsl:value-of select="/UploadFailSubject/ClaimNumber" />
</xsl:template>
...
Nouvelle assignation de supplément de <xsl:value-of select="/NonDrpSuppSubject/CoName" />, Réclamation : <xsl:value-of select="/NonDrpSuppSubject/ClaimNumber" />			  
        </xsl:when>
		<xsl:otherwise>
Nouvelle assignation de supplément, réclamation : <xsl:value-of select="/NonDrpSuppSubject/ClaimNumber" />		
		</xsl:otherwise>
	</xsl:choose>
</xsl:template>

<xsl:template name="faxbody">
Nouvelle assignation On vous a assigné ce qui suit : <xsl:choose><xsl:when test="$assignmentSubTypeDescFax!=''"><b><xsl:value-of select="$assignmentSubTypeDescFax" /></b> Assignation de l'évaluation</xsl:when>
									<xsl:otherwise>Assignation de l'évaluation</xsl:otherwise></xsl:choose> Type de renseignements administratifs/sur le véhicule : <xsl:value-of select="/Fax/EmailMessage/CauseOfLossDesc" />
<xsl:if test="/Fax/EmailMessage/ClaimantName">
Nom du contact :<xsl:value-of select="/Fax/EmailMessage/ClaimantName" />
...
Téléphone du bureau : <xsl:value-of select="/Fax/EmailMessage/WorkPhone" />
</xsl:if>
<xsl:if test="/Fax/EmailMessage/CellPhone">
Téléphone portable : <xsl:value-of select="/Fax/EmailMessage/CellPhone" />
</xsl:if>
</xsl:if> Marque du véhicule : <xsl:value-of select="/Fax/EmailMessage/VehMake" />, Modèle <xsl:value-of select="/Fax/EmailMessage/VehModel" />, Année <xsl:value-of select="/Fax/EmailMessage/VehYear" /> Point d'impact : <xsl:value-of select="/Fax/EmailMessage/Poi" /> Mémo dommages : <xsl:value-of select="/Fax/EmailMessage/DamageMemo" /> Mémo assignation : <xsl:value-of select="/Fax/EmailMessage/AssignmentMemo" /> Préférence de date : <xsl:if test="string-length(/Fax/EmailMessage/PreferMonth) > 0"><xsl:value-of select="/Fax/EmailMessage/PreferMonth" />/<xsl:value-of select="/Fax/EmailMessage/PreferDay" />/<xsl:value-of select="/Fax/EmailMessage/PreferYear" /></xsl:if> Remarques Si vos configurations vous permettent d'utiliser le gestionnaire eClaim de Mitchell vous avez peut-être déjà reçu cette assignation. Veuillez consulter votre boîte de réception dans eClaim pour obtenir les détails de votre assignation. Cordialement, <xsl:value-of select="/Fax/EmailMessage/CoName" />
</xsl:template>
...
L'assignation d'évaluation suivante vous a été attribuée <xsl:choose><xsl:when test="$assignmentSubTypeDescFaxDRP!=''"><b><xsl:value-of select="$assignmentSubTypeDescFaxDRP" /></b> Assignation de l'évaluation</xsl:when><xsl:otherwise>Assignation de l'évaluation</xsl:otherwise></xsl:choose> Type de renseignements administratifs/sur le véhicule : <xsl:value-of select="/FaxDRP/EmailMessageDRP/CauseOfLossDesc" />
<xsl:if test="/FaxDRP/EmailMessageDRP/ClaimantName">
Nom du contact :<xsl:value-of select="/FaxDRP/EmailMessageDRP/ClaimantName" />
...
Téléphone du bureau : <xsl:value-of select="/FaxDRP/EmailMessageDRP/WorkPhone" />
</xsl:if>
<xsl:if test="/FaxDRP/EmailMessageDRP/CellPhone">
Téléphone portable : <xsl:value-of select="/FaxDRP/EmailMessageDRP/CellPhone" />
</xsl:if>
</xsl:if> Marque du véhicule : <xsl:value-of select="/FaxDRP/EmailMessageDRP/VehMake" />, Modèle <xsl:value-of select="/FaxDRP/EmailMessageDRP/VehModel" />, Année <xsl:value-of select="/FaxDRP/EmailMessageDRP/VehYear" /> Point d'impact : <xsl:value-of select="/FaxDRP/EmailMessageDRP/Poi" /> Mémo dommages : <xsl:value-of select="/FaxDRP/EmailMessageDRP/DamageMemo" /> Mémo assignation : <xsl:value-of select="/FaxDRP/EmailMessageDRP/AssignmentMemo" /> Préférence de date : <xsl:if test="string-length(/FaxDRP/EmailMessageDRP/PreferMonth) > 0"><xsl:value-of select="/FaxDRP/EmailMessageDRP/PreferMonth" />/<xsl:value-of select="/FaxDRP/EmailMessageDRP/PreferDay" />/<xsl:value-of select="/FaxDRP/EmailMessageDRP/PreferYear" /></xsl:if> Remarques Si vos configurations vous permettent d'utiliser le gestionnaire eClaim de Mitchell vous avez peut-être déjà reçu cette assignation. Veuillez consulter votre boîte de réception dans eClaim pour obtenir les détails de votre assignation. Cordialement, <xsl:value-of select="/FaxDRP/EmailMessageDRP/CoName" />
</xsl:template>
