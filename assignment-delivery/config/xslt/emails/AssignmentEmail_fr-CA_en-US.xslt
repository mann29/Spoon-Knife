                                         ...
                                         <table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
                                                ...
                                                <tr>
                                                       <td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
                                                              ...
                                                              <p class="text" style="line-height:22px; color:#333333">L'assignation d'évaluation suivante vous a été attribuée <xsl:choose><xsl:when test="$assignmentSubTypeDescBdy!=''"><b><xsl:value-of select="$assignmentSubTypeDescBdy" /></b>vous a été affectée</xsl:when>
                           ...
                           <tr>
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									...
									<!--By vb101824 for PBI 292181 -->
									<p class="text" style="line-height:22px; color:#333333">Si vous n'utilisez pas RC Connect pour communiquer avec cet assureur, veuillez ignorer ce courriel. <ul>
										<li>EXCEPTION : si vous êtes un réparateur hors réseau recevant une affectation pour cette compagnie d'assurance, veuillez conserver ce courriel. Il contient le seul lien que vous recevrez pour accéder aux informations.</li>
									</ul> 
									</p>
...
Échec du chargement de l'estimation pour <xsl:value-of select="/UploadFailSubject/CoName"/> Claim: <xsl:value-of select="/UploadFailSubject/ClaimNumber"/>
</xsl:template>
