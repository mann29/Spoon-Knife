						...
						<table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									...
									<p class="text" style="line-height:22px; color:#333333">Se le ha asignado el siguiente <xsl:choose><xsl:when test="$assignmentSubTypeDescBdy!=''"><b><xsl:value-of select="$assignmentSubTypeDescBdy" /></b> Encargo de valoración</xsl:when>
									<xsl:otherwise>Encargo de valoración</xsl:otherwise></xsl:choose></p>
									<!--By vb101824 for PBI 292181 -->
									<p class="text" style="line-height:22px; color:#333333">Si no utiliza RC Connect para comunicarse con esta compañía, ignore este correo. <ul>
										<li>EXCEPCIÓN: Si es un Taller no colaborador que recibe un encargo de esta compañía, guarde este email. Es el único enlace que recibirá para acceder a la información del encargo.</li>
									</ul>
									</p>
									<p class="text" style="line-height:22px; color:#333333; font-weight: bold;">Datos administrativos/Información del vehículo<hr/></p>
									<table class="text" style="line-height:22px; color:#333333; font-size: 10pt; font-family: Verdana, Geneva, sans-serif;">
										...
										<tr>
											...
											<td style="vertical-align: top">
												<xsl:value-of select="/mxs:EmailMessage/mxs:VehMake" />, Modelo <xsl:value-of select="/mxs:EmailMessage/mxs:VehModel" />, Año <xsl:value-of select="/mxs:EmailMessage/mxs:VehYear" />
											</td>
										</tr>
										<tr>
											<td style="font-weight: bold; text-align: right; vertical-align: top">
									...
									<br/>
									<p>
									<xsl:call-template name="url"/><br/> Haga clic en el enlace anterior y especifique el Número de identificación del vehículo (VIN) asociado con este siniestro.
									</p>
					...
					<td width="600" align="center">
						...
						<table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									<p class="text" style="line-height:22px; font-size:16px; color:#72a493; font-weight:bold">Nuevo encargo</p>
									<p class="text" style="line-height:22px; color:#333333">Se le ha asignado el siguiente <xsl:choose><xsl:when test="$assignmentSubTypeDescBdyDRP!=''"><b><xsl:value-of select="$assignmentSubTypeDescBdyDRP" /></b> Encargo de valoración</xsl:when>
									<xsl:otherwise>Encargo de valoración</xsl:otherwise></xsl:choose></p>
									<!--By vb101824 for PBI 292181 -->
									<p class="text" style="line-height:22px; color:#333333">Si no utiliza RC Connect para comunicarse con esta compañía, ignore este correo. <ul>
										<li>EXCEPCIÓN: Si es un Taller no colaborador que recibe un encargo de esta compañía, guarde este email. Es el único enlace que recibirá para acceder a la información del encargo.</li>
									...
									<table class="text" style="line-height:22px; color:#333333; font-size: 10pt; font-family: Verdana, Geneva, sans-serif;">
										...
										<tr>
											...
											<td style="vertical-align: top">
												<xsl:value-of select="/mxs:EmailMessageDRP/mxs:VehMake" />, Modelo <xsl:value-of select="/mxs:EmailMessageDRP/mxs:VehModel" />, Año <xsl:value-of select="/mxs:EmailMessageDRP/mxs:VehYear" />
											</td>
										</tr>
										<tr>
											<td style="font-weight: bold; text-align: right; vertical-align: top">
									...
									<br/>
									<p>
									<xsl:call-template name="urlDRP"/><br/> Haga clic en el enlace anterior y especifique el Número de identificación del vehículo (VIN) asociado con este siniestro.
									</p>
						...
						<table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									...
									<p class="text" style="line-height:22px; font-size:16px; color:#72a493; font-weight:bold">¡Valoración enviada con éxito!</p>
									
									
									<p class="text" style="line-height:22px; color:#333333">Su valoración se envió con éxito a <xsl:value-of select="/UploadSuccess/CoName" />.</p>
						...
						<table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									...
									<p class="text" style="line-height:22px; color:#333333">Su valoración se envió con éxito a <xsl:value-of select="/UploadSuccessDRP/CoName" />.</p>
						...
						<table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									...
									<p class="text" style="line-height:22px; font-size:16px; color:#72a493; font-weight:bold">Fallo al cargar la valoración</p>
									
									<p class="text" style="line-height:22px; color:#333333">La valoración no pudo procesarla <xsl:value-of select="/UploadFail/CoName" />.</p>
									...
									<p>Vuelva a cargar la valoración usando el enlace proporcionado en el email de encargo original.</p>
						...
						<table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									...
									<p class="text" style="line-height:22px; color:#333333">La valoración no pudo procesarla <xsl:value-of select="/UploadFailDRP/CoName" />.</p>
...
Nuevo encargo Se le ha asignado el siguiente <xsl:choose><xsl:when test="$assignmentSubTypeDescFax!=''"><b><xsl:value-of select="$assignmentSubTypeDescFax" /></b> Encargo de valoración</xsl:when>
									<xsl:otherwise>Encargo de valoración</xsl:otherwise></xsl:choose> Datos administrativos/Tipo de información del vehículo: <xsl:value-of select="/Fax/EmailMessage/CauseOfLossDesc" />
...
Nuevo encargo Se le ha asignado el siguiente <xsl:choose><xsl:when test="$assignmentSubTypeDescFaxDRP!=''"><b><xsl:value-of select="$assignmentSubTypeDescFaxDRP" /></b> Encargo de valoración</xsl:when><xsl:otherwise>Encargo de valoración</xsl:otherwise></xsl:choose> Datos administrativos/Tipo de información del vehículo: <xsl:value-of select="/FaxDRP/EmailMessageDRP/CauseOfLossDesc" />
