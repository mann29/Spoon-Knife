<xsl:transform xmlns:xsl='http://www.w3.org/1999/XSL/Transform' version='1.0' xmlns:mxs="http://www.mitchell.com/schemas/assignmentdelivery"  xmlns:my="http://www.mitchell.com/services/sip/stdassignmentdeliveryemails" exclude-result-prefixes="my">
<xsl:output omit-xml-declaration="yes"></xsl:output>
<!--xsl:output method="html" encoding="iso-8859-1" indent="yes"/-->
<!-- ########## Get the Assignment sub type Map########-->
		<my:map>
			<entry key="PH">Photo and Estimate Only</entry>
			<entry key="PO">Photos Only Assignment</entry>
			<entry key="TL">Total Loss</entry>
			<entry key="PR">Police Report</entry>
			<entry key="PE">Preserve Evidence</entry>
			<entry key="RE">Reinspection</entry>
			<entry key="SI">Scene Investigation</entry>
			<entry key="TR">Theft Recovery</entry>
			<entry key="CS">Customer Service</entry>
			<entry key="SP">Special Investigation</entry>
			<entry key="IO">Inspection Only - No Repair</entry>
			<entry key="CT">Catastrophe</entry>
			<entry key="DW">Desk Work</entry>
			<entry key="AU">Audit</entry>
			<entry key="DS">Desk Supplement</entry>
			<entry key="OF">Other Field</entry>
			<entry key="ST">Supplement Task</entry>
		</my:map>
	<xsl:variable name="assignmentSubTypeCode" select="/CreationSubject/AssignmentSubTypeCode"/>
	<xsl:variable name="assignmentSubTypeDesc">
		<xsl:value-of select="document('')/*/my:map/entry[@key=$assignmentSubTypeCode]"/>
	</xsl:variable>
	<xsl:variable name="assignmentSubTypeCodeBdy" select="/mxs:EmailMessage/mxs:AssignmentSubTypeCode"/>
	<xsl:variable name="assignmentSubTypeDescBdy">
		<xsl:value-of select="document('')/*/my:map/entry[@key=$assignmentSubTypeCodeBdy]"/>
	</xsl:variable>
						...
						<table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									...
									<p class="text" style="line-height:22px; color:#333333">You have been assigned the following <xsl:choose><xsl:when test="$assignmentSubTypeDescBdy!=''">Appraisal <xsl:value-of select='$assignmentSubTypeDescBdy'/> Assignment</xsl:when>
									...
									<p class="text" style="line-height:22px; color:#333333">Regards,<br/><xsl:value-of select="/EmailMessage/CoName"/></p>
					...
					<td width="600" align="center">
						...
						<table width="710" border="0" align="center" cellpadding="5" cellspacing="0"  style="background-color:#fff">
							...
							<tr>
								<td colspan="2" valign="top" style="text-align:left; padding-left:35px; padding-top:25px; padding-right:35px; padding-bottom:15px; font-family: Verdana, Geneva, sans-serif; color: #333; font-size: 12px;">
									<p class="text" style="line-height:22px; font-size:16px; color:#72a493; font-weight:bold">New Assignment</p>
									<p class="text" style="line-height:22px; color:#333333">You have been assigned the following Appraisal Assignment</p>
									<!--By vb101824 for PBI 292181 -->
									<p class="text" style="line-height:22px; color:#333333">If you don&#39;t use RC Connect to communicate with this carrier please disregard this email
									<ul>
										<li>EXCEPTION: If you are a Non-Network shop receiving an assignment for this carrier, please save this email. It is the only link you will receive to access the information.</li>
									...
									<p class="text" style="line-height:22px; color:#333333">Regards,<br/><xsl:value-of select="/EmailMessageDRP/CoName"/></p>
...
New Assignment
You have been assigned the following Appraisal Assignment
