...
* in the Tree.
*/
public abstract class Tree<T  extends Serializable> implements Serializable {
   ...
   public abstract  Node<T> findNode(Node<T> node, QuestionRqRsDto keyNode);
   public abstract  Node<T> findSibling(Node<T> node);
   public abstract  Node<T> findQuestOnSelectedAnswer(Node<T> node, Answer keyNode);
}
