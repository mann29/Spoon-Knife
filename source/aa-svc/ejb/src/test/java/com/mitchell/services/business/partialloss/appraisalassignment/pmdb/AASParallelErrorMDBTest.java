...
public class AASParallelErrorMDBTest
{
  protected AASParallelErrorMDB testClass;

  @Before
  public void setUp()
      throws Exception
  {
    this.testClass = mock(AASParallelErrorMDB.class);
      ...
      throws Exception
  {
    ...
    verify(this.testClass.parallelProcessor).handleProcessingRequestError(msg);
      ...
      throws Exception
  {
    ...
    doThrow(meThrow).when(this.testClass.parallelProcessor)
        .handleProcessingRequestError(msg);
