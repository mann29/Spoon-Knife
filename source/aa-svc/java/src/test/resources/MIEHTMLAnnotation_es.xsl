			...
			<tr>
				<td class="section-padding">
					<table border="0" cellpadding="0" cellspacing="0" width="50%" ID="Table5">
						<tr>
							<td class="subsection">
								<!--Subsection--> Perfil de valoraciÃ³n:
		</td>
...
count(/sup:SupplementRequest/sup:EstimateProfile/sup:RateInfo) > 0">
			<tr>
				<td class="section">
					<!--Section--> InformaciÃ³n de fotoperitaciÃ³n
	</td>
			</tr>
			...
			<xsl:if test="string-length(/sup:SupplementRequest/sup:DeskReviewInfo/sup:Comments) > 0">
				<tr>
					<td class="subsection">
						<!--Subsection--> Comentarios de fotoperitaciÃ³n
		</td>
				</tr>
				<tr>
					<td class="subsection-content">
			...
			<tr>
				<td class="subsection-content">
					...
					<div class="col-bg-large">
						<span class="subsection">Anotaciones del elemento de lÃ­nea</span>
					</div>
					<table width="100%" cellspacing="0" cellpadding="0" border="0" class="data-table" ID="Table3">
						<tr>
							<td class="data-table-head-first" rowspan="2">LÃ­nea</td>
							<td class="data-table-head" rowspan="2">OperaciÃ³n</td>
							<td class="data-table-head" rowspan="2">DescripciÃ³n</td>
						...
						<tr>
							...
							<td class="data-table-head" style="border-top: 1px solid #bebebe;">NÃºmero</td>
...
<a href="{$vlink}">Enlace</a>
	...
	<xsl:template name="claimheader">
		...
		<tr>
			<td class="section">
				<!--Section--> Solicitud de modificaciÃ³n para NÂº de siniestro <xsl:value-of select="/sup:SupplementRequest/sup:AdminInfo/sup:ClaimNumber"/>
			</td>
		</tr>
		<tr> 
<xsl:if test="string-length(/sup:SupplementRequest/sup:AdminInfo/sup:URLLink) > 0">
Para ver el encargo completo, haga clic en el siguiente enlace y especifique el NÃºmero de identificaciÃ³n del vehÃ­culo (VIN) asociado con este siniestro.<br/>
	...
	<xsl:template name="adminvehicle">
		<tr>
					...
					<tr>
						<td class="subsection-content">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" ID="Table2">
								<tr>
									<td width="25%" class="data-field">NÂº de siniestro:</td>
									<td width="25%" class="data">
										<xsl:value-of select="/sup:SupplementRequest/sup:AdminInfo/sup:ClaimNumber"/>
									</td>
									<td width="25%" class="data-field">ID de valoraciÃ³n:</td>
									<td width="25%" class="data">
								...
								<tr>
									...
									<td width="25%" class="data-field">CompaÃ±Ã­a de seguros:</td>
									<td width="25%" class="data">
								...
								<tr>
									<td width="25%" class="data-field">TelÃ©fono:</td>
									<td width="25%" class="data">
								...
								<tr>
									<td width="25%" class="data-field">DirecciÃ³n:</td>
									<td width="25%" class="data">
			...
			, <xsl:value-of select="/sup:SupplementRequest/sup:AdminInfo/sup:ReceipientInfo/sup:State"/>
									...
									<td width="25%" class="data-field">Â </td>
									<td width="25%" class="data">Â </td>
								</tr>
							</table>
						</td>
					</tr>
					<tr>
						<td class="subsection">
							<!--Subsection--> InformaciÃ³n del vehÃ­culo
		</td>
					</tr>
					<tr>
						<td class="subsection-content">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" ID="Table6">
								<tr>
									<td width="25%" class="data-field">AÃ±o:</td>
									<td width="25%" class="data">
										<xsl:value-of select="/sup:SupplementRequest/sup:VehicleInfo/sup:Year"/>
									</td>
									<td width="25%" class="data-field"> Nombre del propietario del vehÃ­culo:</td>
									<td width="25%" class="data">
...
<xsl:if test="string-length(/sup:SupplementRequest/sup:AdminInfo/sup:URLLink) &lt;= 0">
		...
		<tr>
			<td class="section">
				<!--Section--> Instrucciones de modificaciÃ³n para valoraciones
		...
		<tr>
			<td class="subsection-content">
				...
				<table>
					<tr>
						<td class="data-right">1.Â </td>
						<td class="data">Abra eClaim Manager</td>
					</tr>
					<tr>
						<td class="data-right">2.Â </td>
						<td class="data">Localice y abra la Carpeta de siniestros en eClaim Manager</td>
					</tr>
					<tr>
						<td class="data-right">3.Â </td>
						<td class="data">Realice una de las siguientes acciones:</td>
					</tr>
					<tr>
						<td class="data-right">Â </td>
						<td class="data">Si utiliza UltraMate:</td>
					</tr>
					<tr>
						<td class="data-right">Â Â Â </td>
						<td class="data">3a.Â Inicie UltraMate desde eClaim Manager.</td>
					</tr>
					<tr>
						<td class="data-right">Â Â Â </td>
						<td class="data">3b.Â Actualice y calcule la valoraciÃ³n, luego haga clic en el botÃ³n eCM para confirmar la valoraciÃ³n y volver a eClaim Manager.</td>
					</tr>
					<tr>
						<td class="data-right">Â </td>
					...
					<tr>
						<td class="data-right">Â Â Â </td>
						<td class="data">3a.Â Abra el software de valoraciÃ³n.</td>
					</tr>
					<tr>
						<td class="data-right">Â Â Â </td>
						<td class="data">3b.Â Actualice y luego confirme o bloquee la valoraciÃ³n.</td>
					</tr>
					<tr>
						<td class="data-right">Â Â Â </td>
						<td class="data">3c.Â Exporte el EMS para la valoraciÃ³n desde el software de valoraciÃ³n.</td>
					</tr>
					<tr>
						<td class="data-right">Â Â Â </td>
						<td class="data">3d.Â Cree una imagen de impresiÃ³n de la valoraciÃ³n en formato PDF.</td>
					</tr>
					<tr>
						<td class="data-right">Â Â Â </td>
						<td class="data">3e.Â En eClaim Manager, importe el EMS modificado y el PDF.</td>
					</tr>
					<tr>
						<td class="data-right">4.Â </td>
						<td class="data">En eClaim Manager, marque la carpeta como Lista para enviar, luego haga clic en el botÃ³n con la bombilla.</td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<xsl:template name="conf">
		<tr>
			<td class="section">
				<!--Section--> DeclaraciÃ³n de confidencialidad
	</td>
		</tr>
		<tr>
			<td class="subsection-content">
		...
		La informaciÃ³n incluida en este mensaje es CONFIDENCIAL y solo para el destinatario previsto. <br/> EstÃ¡ totalmente prohibido cualquier uso no autorizado, reenvÃ­o de la informaciÃ³n o copia del mensaje. <br/> Si no es el destinatario previsto, por favor hÃ¡gaselo saber al remitente de inmediato y borre el mensaje.<br/>
				</span>
			</td>
		</tr>
</xsl:template>
