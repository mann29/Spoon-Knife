			...
			<tr>
				<td class="subsection-content">
					...
					<div class="col-bg-large">
						<span class="subsection">Annotations des éléments</span>
					</div>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" class="data-table" ID="Table3">
						<tr>
							...
							<td class="data-table-head" rowspan="2">Numéro</td>
							...
							<td class="data-table-head" rowspan="2">Type</td>
							<td class="data-table-head" rowspan="2">Identifiant</td>
		...
		<tr>
			<td class="subsection-content">
				...
				<table>
					...
					<tr>
						<td class="data-right">2.&#160;</td>
						<td class="data">Rendez-vous à la page de détails de votre assignation.</td>
					</tr>
					<tr>
						<td class="data-right">3.&#160;</td>
