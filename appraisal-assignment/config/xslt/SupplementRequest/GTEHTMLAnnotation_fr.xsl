				...
				<td class="section-padding">
					<table border="0" cellpadding="0" cellspacing="0" width="50%" ID="Table5">
						<tr>
							...
							<tr>
								<td class="data-table-head-first" style="border-style: none">Tarif de main d'œuvre (<xsl:value-of select="/sup:SupplementRequest/sup:AdminInfo/sup:Currency" />/h)</td>
				...
				<td class="subsection-content">
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" class="data-table" ID="Table3">
						<tr>
							...
							<td class="data-table-head" rowspan="2">Type</td>
							<td class="data-table-head" rowspan="2">Remise</td>
							<td class="data-table-head" rowspan="2">Remise en %</td>
		...
		<tr>
			<td class="subsection-content">
				...
				<table>
					...
					<tr>
						<td class="data-right">2. </td>
						<td class="data">Rendez-vous à la page de détail des affectations pour votre affectation.</td>
					</tr>
					<tr>
						<td class="data-right">3. </td>
				...
				<td>
					<table width="80%" cellspacing="0" cellpadding="0" border="0" id="Table15">
						<tr>
							...
							<td class="data-right">Sous-traiter</td>
