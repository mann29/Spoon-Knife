...
public class ClaimaintTestMEUpdateHandlerImpl extends BaseTestMEUpdateHandlerImpl {


	protected PartyType getPartyType(AdminInfoType adminInfoType) {
		// TODO Auto-generated method stub
		return adminInfoType.getClaimant().getParty();
	}


	protected PersonInfoType getPersonInfoType(AdminInfoType adminInfoType) {
		// TODO Auto-generated method stub
		return adminInfoType.getClaimant().getParty().getPersonInfo();
	}
