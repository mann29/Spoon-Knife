...
public class MIEBMSTextEmailFormatter
{
      ...
      throws IOException, IllegalAccessException
  {
    ...
    String file = aasCommonUtil.getSystemConfigurationSettingValue(
        "/AppraisalAssignment/SuppRequest/TextFormat/MIE/MIETemplateFile",
        "MIE_BMS_Supp_Request_Template.txt");
    ...
    String propsList = aasCommonUtil
        .getSystemConfigurationSettingValue(
            "/AppraisalAssignment/SuppRequest/TextFormat/MIE/MIETemplateProps",
  ...
  {
    //return getSubtotal("Parts SubTotals",suppRequestDoc.getSupplementRequest().getPartsSubTotals());
    String part = "";
