 ...
 * @since 1.0
 */
public class WorkProcessUpdateMessageContext { 
    /**
     * Activity operation.
     */
    private String activityOperation = null;
    /**
     * Collaborator.
     */
     ...
     * activity operation
     */
    public void setActivityOperation(String activityOperationArg) {
        this.activityOperation = activityOperationArg;
    }
    /**
     * Get Collaborator.
     * @return String
